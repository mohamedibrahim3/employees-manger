...
export const efficiencyGradeEnum = z.enum([
  "EXCELLENT",
  "COMPETENT",
  "AVERAGE",
  "BELOW",
...
export type EfficiencyGrade = z.infer<typeof efficiencyGradeEnum>;
  ...
  efficiencyReports: z
    .array(
      z.object({
        ...
        grade: efficiencyGradeEnum.or(z.literal("")).default(""),
        description: z.string().min(1, "الوصف مطلوب"),
        attachments: z.string().optional(),
      })
    )
...
export function transformEmployeeFormToApi(
  ...
  return {
    ...
    educationalDegree:
      (data.educationalDegree as CreateEmployeeApi["educationalDegree"]) ||
      null,
    functionalDegree:
      (data.functionalDegree as CreateEmployeeApi["functionalDegree"]) || null,
  };
}

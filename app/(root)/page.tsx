    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-white relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-none px-4 lg:px-8 xl:px-12 py-12 space-y-12">
        ...
        <div className="text-center space-y-6">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gray-700 rounded-2xl shadow-xl mb-6 animate-pulse">
          ...
          <p className="text-xl text-gray-600 font-medium">الخاص بجهاز تعمير سيناء</p>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-white rounded-3xl p-12 text-center shadow-xl transform group-hover:scale-105 transition-all duration-300 max-w-lg w-full">
              ...
              <div className="mb-6">
                ...
                <p className="text-lg text-gray-600 font-medium">موظف نشط</p>
              </div>

              <Link href="/employees" className="group/btn relative inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-white bg-gradient-to-r from-gray-700 to-gray-600 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 overflow-hidden">
        ...
        <div className="w-full max-w-none">
          <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-xl overflow-hidden border border-gray-200">
            <div className="bg-gradient-to-r from-gray-800 to-gray-600 px-12 py-8">
              <h3 className="text-3xl font-medium text-white text-center">توزيع الموظفين حسب الإدارات والمناطق</h3>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                  <tr>
                    <th className="px-6 py-4 text-right text-lg font-medium text-gray-700 border-b-2 border-gray-300 w-1/2">الإدارة / المنطقة</th>
                    <th className="px-6 py-4 text-right text-lg font-medium text-gray-700 border-b-2 border-gray-300 w-1/4">عدد الموظفين</th>
                    <th className="px-6 py-4 text-right text-lg font-medium text-gray-700 border-b-2 border-gray-300 w-1/4">إجراء</th>
                  </tr>
                </thead>
                <tbody>
                  {ADMINISTRATIONS_AND_REGIONS.map((admin, index) => {
                    ...
                    return (
                      <tr
                        key={admin}
                        className={`group hover:bg-gray-50 transition-all duration-300 ${index % 2 === 0 ? "bg-white" : "bg-gray-50/50"}`}
                      >
                        <td className="px-6 py-4 text-gray-800 font-medium text-lg group-hover:text-gray-700 transition-colors duration-300">
                          <div className="flex items-center">
                            <div className="w-3 h-10 bg-gray-600 rounded-full ml-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            {admin}
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <div className="flex items-center">
                            <span className="inline-flex items-center justify-center w-16 h-16 bg-gray-100 rounded-xl text-gray-700 font-medium text-lg ml-4">
                              {toArabicDigits((emps as []).length)}
                            </span>
                            <span className="text-gray-600 text-base">موظف</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                          <Link href={`/groups/administration/${encodeURIComponent(admin)}`} className="group/link inline-flex items-center px-8 py-4 bg-gradient-to-r from-gray-700 to-gray-600 text-white rounded-xl font-medium text-base shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 hover:from-gray-600 hover:to-gray-700">
        ...
        <div className="w-full max-w-none">
          <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-xl overflow-hidden border border-gray-200">
            <div className="bg-gradient-to-r from-gray-800 to-gray-600 px-12 py-8">
              <h3 className="text-3xl font-medium text-white text-center">بحث عن موظف</h3>
            </div>
            <div className="p-8">
        ...
        <div className="text-center pt-8">
          <p className="text-gray-600 text-base">آخر تحديث: {new Date().toLocaleDateString("ar-EG")}</p>
        </div>
      </div>
    </div>
  );
